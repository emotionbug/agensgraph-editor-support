...
var _default = function _default(element) {
  var call = _TreeUtils.default.findAnyParent(element, [CypherTypes.CALL_CONTEXT]);

  if (call != null) {
    var procedure = _TreeUtils.default.findChild(call, CypherTypes.PROCEDURE_NAME_CONTEXT);

    var resultOutput = _TreeUtils.default.findAnyParent(element, CypherTypes.PROCEDURE_RESULTS_CONTEXT);
...
//# sourceMappingURL=ruleProcedureOutputsInCallClause.js.map